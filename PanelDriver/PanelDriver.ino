/**********************************************************************
  ...
  ***************************************** 
  Yellow Color Modification by Gavin Taylor
  *****************************************
  ...
  **** This branch written specifically for the 2014 RobotX challenge uses a custom driver *****
    ...
    **** Now we must change to another color option...YELLOW! ****
  ...
  if(ET.receiveData()){
    ...
    if(packet.address == 0) {
      ...
      switch (packet.displaydata[0][0]){
        ...
        break;
        case 252: // 8 bit color yellow 111 111 00
          matrix.setColour(STATYELLOW);
        break;
